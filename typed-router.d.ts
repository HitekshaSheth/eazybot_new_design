...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'error-coming-soon': RouteRecordInfo<'error-coming-soon', '/error/coming-soon', Record<never, never>, Record<never, never>>,
    'error-not-authorized': RouteRecordInfo<'error-not-authorized', '/error/not-authorized', Record<never, never>, Record<never, never>>,
    'error-under-maintenance': RouteRecordInfo<'error-under-maintenance', '/error/under-maintenance', Record<never, never>, Record<never, never>>,
